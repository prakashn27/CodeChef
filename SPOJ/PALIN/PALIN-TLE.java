...
class PALIN {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		*/
		...
		while(noOfTestCases != 0) {
			...
			BigInteger BigInp = new BigInteger(inp);
			inp = BigInp.toString(); //BigInteger.
			int l = inp.length();
			char[] dst = new char[l];
			...
			if(allAre9(dst,l)) {
				...
				BigInteger bigCopyInp = new BigInteger(copyInp);
	...
	public static Boolean checkPalindrome(String Palin) {
	 ...
	 //to check all the input is 9- If any one element is not 9 it will return false else true
